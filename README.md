...
| **Behavioral guide** | `guide.md` is the source of truth for how the agent should behave — tone, routing, time handling, receipt parsing, refunds, and more. Read it to understand the full operating concept. |
